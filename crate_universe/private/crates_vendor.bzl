...
def write_config_file(
    ...
    Args:
        ...
        repo_name (str): The name of the repo being generated.
        write_data_file: A function that takes in ctx, the filename, and the
            data to write, and writes the specified file to the generated repo.
